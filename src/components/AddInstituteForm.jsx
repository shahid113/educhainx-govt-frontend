...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
   ...
   return (
  <div className="max-w-lg w-full mx-auto px-4 sm:px-0 pb-10">

    {/* === ALERTS === */}
    {errors.form && (
      <div className="mb-4 rounded-lg bg-red-50 border border-red-200 px-4 py-3 text-red-700 text-sm font-medium flex items-center gap-2">
    ...
    {success && (
      <div className="mb-4 rounded-xl bg-green-50 border border-green-200 px-4 py-3 flex items-start gap-3">
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g., Indian Institute Of Information Technology Guwahati"
          />
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g., U-1250"
          />
          {errors.instituteCode && <p className="mt-1 text-sm text-red-600">{errors.instituteCode}</p>}
          <p className="mt-1 text-xs text-gray-500">Short unique identifier (acronym).</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="contact@iiitg.ac.in"
          />
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">Ethereum-compatible (0x + 40 hex chars)</p>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 px-5 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium rounded-lg shadow hover:from-indigo-700 hover:to-purple-700 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition disabled:opacity-70"
        >
          {loading ? (
            <>
