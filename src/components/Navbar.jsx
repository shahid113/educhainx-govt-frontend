        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-2">
              <h1 className="text-xl font-bold text-gray-900">Blockchain For Institutes</h1>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Settings */}
            <button className="p-2 text-gray-600 hover:text-blue-700 hover:bg-gray-100 rounded-lg transition hidden sm:block">
              <Settings size={20} />
            </button>
            ...
            <div className="relative group">
              <button className="flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 transition">
                ...
                <ChevronDown size={16} className="text-gray-500 group-hover:text-blue-700 transition hidden sm:block" />
              </button>
