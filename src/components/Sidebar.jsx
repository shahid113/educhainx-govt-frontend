...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <button
        className="lg:hidden fixed top-4 left-4 z-50 bg-white p-2.5 rounded-lg shadow-lg border border-gray-200 hover:bg-gray-50 transition-all"
        onClick={() => setOpen(!open)}
      >
        {open ? <X size={22} className="text-blue-700" /> : <Menu size={22} className="text-blue-700" />}
      </button>

      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 w-72 bg-white shadow-xl transform transition-all duration-300 ease-in-out z-40 flex flex-col
        ...
        <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-blue-700 to-blue-800">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-100 text-xs font-medium">Blockchain System</p>
            </div>
          </div>
        </div>
